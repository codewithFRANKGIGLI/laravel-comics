                ...
                <div class="d-flex justify-content-center dc-contacts">
                    <div class="col-8 d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center dc-followCont">
                            ...
                            <a href="#" class="ms-3"><img src="{{ Vite::asset('resources/img/footer-facebook.png') }}"
                                    alt=""></a>
                            <a href="#" class="ms-3"><img src="{{ Vite::asset('resources/img/footer-twitter.png') }}"
                                    alt=""></a>
                            <a href="#" class="ms-3"><img src="{{ Vite::asset('resources/img/footer-youtube.png') }}"
                                    alt=""></a>
                            <a href="#" class="ms-3"><img src="{{ Vite::asset('resources/img/footer-pinterest.png') }}"
                                    alt=""></a>
                            <a href="#" class="ms-3"><img src="{{ Vite::asset('resources/img/footer-periscope.png') }}"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
